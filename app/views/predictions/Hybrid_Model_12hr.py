...
def main_model(asset_chunk_type, symbols, symbol_to_name):
    ...
    now = datetime.now()
    print(f"Starting 12hr Prediction at.... {now}")
    ...
    for symbol in symbols:
        try:
            ...
            asset_alt_names = symbol_to_name.get(asset_name) or symbol_names.get(asset_name) or asset_name
            quote = "USDT"     
            ...
            lstm_pred_real = scaler.inverse_transform([[lstm_pred_scaled.flatten()[0]]])[0][0]
